...
#### 논문 작성 요청 프롬프트
```
논문 주제: 생성형 AI 기반 프로젝트 기반 학습 평가: LLM 활용 과정과 GitHub 포트폴리오의 통합 모델 
저자: 김철수(단독저자)
소속: 인공지능소프트웨어학과 / 한국대학교
이메일: chulsoo@korea.ac.kr
목표 페이지: 4페이지

위 정보로 학술대회 논문을 작성하는데, 반드시 스킬의 내용을 모두 꼼꼼히 적용해서 작성해 줘
```
