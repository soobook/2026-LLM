...
| 1일차 | 교시 | 주제 || 2일차 | 교시 | 주제 |
| ---- |------|------|-|---- |------|------|
| 2026.07.28 화 | 1교시 | 노벨상으로 알아보는 인공지능과 거대언어모델(LLM) || 2026.07.29 수 | 1교시 | 클로드 활용 |
...
gantt
    ...
    3교시 - 대화질문 설계 프롬프트 엔지니어링 :done, a3, 2026-07-28-13, 6h
    4교시 - ChatGPT 활용                 :done, a4, after a2, 5h
    5교시 - 제미나이와 NotebookLM, Manus :done, a5, after a2, 5h
...
### 관련 유튜브 동영상
> - [빅밸부터 문명까지](https://www.youtube.com/watch?v=vxGQbf1koHk)
